import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaBootstrap, FaNodeJs, FaPython } from "react-icons/fa";
import { SiNextdotjs, SiMongodb, SiMysql, SiPostgresql, SiTypescript, SiTailwindcss, SiThreedotjs } from "react-icons/si";
    ...
    content: (
      <div className="flex flex-col gap-4">
        ...
        <MeteorCard
          content={
            <div>
              <h1 className="text-xl pb-4">Backend</h1>
              <div className="flex flex-wrap justify-start gap-4">
                {/* Backend Skill Icons */}
                <motion.div whileHover={{ scale: 1.2 }} className="flex flex-col items-center">
        ...
        <MeteorCard
          content={
            <div>
              <h1 className="text-xl pb-4">Programming Languages</h1>
              <div className="flex flex-wrap justify-start gap-4">
                ...
                <motion.div whileHover={{ scale: 1.2 }} className="flex flex-col items-center">
                  <p className="text-4xl text-gray-800 font-bold">C++</p>
